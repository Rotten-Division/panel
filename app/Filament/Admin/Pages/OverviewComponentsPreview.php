    ...
    protected function getViewData(): array
    {
        return [
            'pillVariants' => [
                ...
                ['transferring' => false, 'state' => ServerState::Stashed, 'container' => null, 'caption' => 'stashed'],
                ['transferring' => false, 'state' => ServerState::Retrieving, 'container' => null, 'caption' => 'retrieving'],
                ['transferring' => false, 'state' => ServerState::Stashing, 'container' => null, 'caption' => 'stashing'],
            ...
            'bannerVariants' => [
                ...
                ['variant' => 'stashed', 'title' => 'In cold storage', 'subtitle' => 'Wake the server to bring it back', 'progress' => false, 'icon' => null],
                ['variant' => 'suspended', 'title' => 'Account suspended', 'subtitle' => 'Contact support to restore access', 'progress' => false, 'icon' => null],
            ],
            'heroVariants' => [
                ['variant' => 'stashed', 'title' => 'Resting in cold storage', 'body' => 'This server was moved to long-term storage to keep things tidy.'],
                ['variant' => 'retrieve', 'title' => 'Waking up', 'body' => 'Pulling your server back online. Typically takes a minute or two.'],
                ['variant' => 'stash', 'title' => 'Stashing for cold storage', 'body' => 'Saving your server to cold storage so it stays safe.'],
